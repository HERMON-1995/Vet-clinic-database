...
```sh
  ...
  git clone https://github.com/HERMON-1995/Vet-clinic-database.git
```
...
Feel free to check the [issues page](https://github.com/HERMON-1995/Vet-clinic-database/issues).
